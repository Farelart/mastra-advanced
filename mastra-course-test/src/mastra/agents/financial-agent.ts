...
const openai = createOpenAI({
  baseURL: "https://ai-contact8792ai023138680672.openai.azure.com/openai/v1/",
...
- Maintain user trust by ensuring data privacy and security.`,
  model: openai("gpt-4.1-mini"), // You can use "gpt-3.5-turbo" if you prefer
  tools: { getTransactionsTool }, // Now includes our transaction tool
  memory: new Memory({
